 ...
 * @author zhulingjun
 */
@SuppressLint("NewApi") public class ZoomScrollPinnedListView extends PinnedSectionListView
    ...
    public ZoomScrollPinnedListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ZoomScrollPinnedListView(Context context, AttributeSet attrs, int defStyle) {
     ...
     */
    public void addHeadViewBeforeSetAdapter(View layoutView, View headView) {
    ...
    @Override @Deprecated public void addHeaderView(View v) {
