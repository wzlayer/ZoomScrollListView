...
public class PinnedSectionListView extends ListView {
    ...
    void createPinnedShadow(int position) {
        ...
        // measure & layout
        int ws =
            MeasureSpec.makeMeasureSpec(getWidth() - getListPaddingLeft() - getListPaddingRight(),
                MeasureSpec.EXACTLY);
    ...
    @Override protected void dispatchDraw(Canvas canvas) {
        ...
        if (mPinnedSection != null) {
            ...
            int clipHeight = view.getHeight() + (mShadowDrawable == null ? 0
                : Math.min(mShadowHeight, mSectionsDistanceY));
